...
<body class="home">
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/pexels-matthardy-1533720.jpg');">
				<div class="container">

					<h1>your bright future starts here now</h1>
					<p>Finding your next job on TMS Jobs</p>
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<div class="section-title">
								...
								<br><h2  style="text-transform: capitalize;">Companies offering vacancies</h2>
