...
<head>
	...
	<title>TMS Jobs - Employee Profile</title>
	...
	<div class="container-wrapper">
		...
		<div class="main-wrapper">
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3">
														...
														<textarea name="about" class="bootstrap3 form-control" placeholder="Enter your short description ..." style="height: 200px;"><?php echo "$mydesc"; ?></textarea>
													</div>
			...
			<footer class="footer-wrapper">
				...
				<div class="main-footer" style="background-color: #6e868e;">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>TMS Jobs is a job portal, online job management system developed by Nathaniel Nkrumah for his project in february 2018.</p>
