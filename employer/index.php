											...
											<div class="row gap-20">
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group">
														...
														<textarea name="background" class="bootstrap3 form-control" placeholder="Enter company background ..." style="height: 200px;"><?php echo "$desc"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group">
														...
														<textarea name="services" class="bootstrap3 form-control" placeholder="Enter company services ..." style="height: 200px;"><?php echo "$myserv"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="expertise" class="bootstrap3 form-control" placeholder="Enter company expertise ..." style="height: 200px;"><?php echo "$myex"; ?></textarea>
													</div>
