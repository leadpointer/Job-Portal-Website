											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea class="form-control bootstrap3" name="description" required placeholder="Enter description ..." style="height: 200px;"></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="responsiblities" required class="form-control bootstrap3" placeholder="Enter responsiblities..." style="height: 200px;"></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="requirements" required class="form-control bootstrap3" placeholder="Enter requirements..." style="height: 200px;"></textarea>
													</div>
