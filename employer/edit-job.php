...
<head>
	...
	<title>TMS Jobs - <?php echo "$jobtitle"; ?></title>
	...
	<div class="container-wrapper">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="../"><img src="../images/LOGO_TMS.png" alt="Logo" /></a>
						</div>
					</div>
		...
		<div class="main-wrapper">
										...
										<form class="post-form-wrapper" action="app/update-job.php" method="POST" autocomplete="off">
											...
											<?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3">
														<label>Job Description</label>
														<textarea class="form-control bootstrap3" name="description" required placeholder="Enter description ..." style="height: 200px;"><?php echo "$jobdescription"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wrapper">
														<label>Job Responsibilies</label>
														<textarea name="responsiblities" required class="form-control bootstrap3" placeholder="Enter responsiblities..." style="height: 200px;"><?php echo "$jobrespo"; ?></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wrapper">
														...
														<textarea name="requirements" required class="form-control bootstrap3" placeholder="Enter requirements..." style="height: 200px;"><?php echo "$jobreq"; ?></textarea>
													</div>
			...
			<footer class="footer-wrapper">
				...
				<div class="main-footer" style="background: #6e868e">
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About TMS Jobs</h5>
											<p>TMS Jobs is a Merchant navy recruiters website which solves the issue of marinetime candidates to apply for vacancies now all at one place.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">TMS Jobs Contact</h5>
								
								<p>Address : Takoradi, School Junction PO.BOX AX40</p>
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">tmshipping@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Tanvi Marine Services</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Tanvi Sharma</a></li>
								</ul>
